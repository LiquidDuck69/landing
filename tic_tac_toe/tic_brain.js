...
//Did player x win or not? lets check//
...
//Checking to see if player 0 has won or not//
...
else if ((b1 == 'X' || b1 == '0') && (b2 == 'X' || '0') && (b3 == 'X' || b3 == '0') &&
...
(b7 == 'X' || b7 == '0') && (b8 == 'X' || b8 == '0') && (b9 == 'X' || b9 == '0')) {
    ...
    //Lets add some turn counter type stuff//
    if (flag == 1) {
        document.getElementById('print')
...
//To check the turns and use the appropriate X or 0//
flag = 1;
function myfunc_3() {
    if (flag == 1) {
